...
public class PayrollSystem extends JFrame {
    ...
    public PayrollSystem() {
        ...
        // Set up colors
        Color primaryColor = new Color(241, 196, 15); //Golden Yellow
        Color secondaryColor = new Color(46, 204, 113); //Medium Sea Green
        Color accentColor = new Color(52, 152, 219); //Blue
        Color buttonColor = new Color(231, 76, 60); //Red
        Color textColor = Color.WHITE; //Added for better readability
